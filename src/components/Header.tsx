...
const Header = () => {
  ...
  const navItems = getNestedValue(content, 'header.navItems', defaultNavItems);
  const headerCta = getNestedValue(content, 'header.callToAction', 'Get Started');
  const headerCtaHref = getNestedValue(content, 'header.callToActionHref', '/contact');
        ...
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <Button variant="coral" size="lg" asChild>
              <Link to={headerCtaHref}>{headerCta}</Link>
            </Button>
          </div>
