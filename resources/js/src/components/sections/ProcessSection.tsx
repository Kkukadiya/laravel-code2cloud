...
const steps = [
  {
    ...
    icon: Search,
    title: 'Discovery',
    description: 'We start by listening. What problem are you solving? Who are your users? What has worked before and what has not?',
  },
  {
    number: '02',
    icon: Lightbulb,
    title: 'Planning',
    description: 'Based on your goals and budget, we map out the technical approach, timeline, and milestones you can actually track.',
  },
  {
    number: '03',
    icon: Code2,
    title: 'Build',
    description: 'Our developers write clean, documented code. You get regular updates and access to staging environments throughout.',
  },
  {
    number: '04',
    icon: Settings,
    title: 'Quality Check',
    description: 'Every feature goes through manual and automated testing. We catch bugs before your users do.',
  },
  {
    number: '05',
    icon: Rocket,
    title: 'Go Live',
    description: 'Deployment day should be boring — no surprises, no downtime. We handle the technical details of getting you live.',
  },
  {
    number: '06',
    icon: HeadphonesIcon,
    title: 'Ongoing Support',
    description: 'Software needs care after launch. We offer maintenance plans that keep your systems secure and running smoothly.',
  },
];
